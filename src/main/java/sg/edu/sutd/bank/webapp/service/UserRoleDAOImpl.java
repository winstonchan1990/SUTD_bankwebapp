...
//		This SQL query is not vulnerable to SQL injection because it does not use dynamic queries 
//		to concatenate malicious data to the query itself (i.e. correctly uses parameterised
//		queries) - note the placeholders (?,?) used in the arguments for prepareStmt.
//		(Refer to https://blogs.msdn.microsoft.com/sqlphp/2008/09/30/how-and-why-to-use-parameterized-queries/)		
