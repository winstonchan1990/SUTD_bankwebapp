...
public interface TransactionCodesDAO {
	...
	boolean isTransationCodeUsed(String codes, int userId) throws ServiceException;
	
	void updateTxnCodeStatus(String codes, int userId, Boolean status) throws ServiceException;
